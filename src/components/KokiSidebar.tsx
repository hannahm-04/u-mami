...
const navItems = [
  { label: "Pembuatan Pesanan", path: "/koki/pembuatan" },
  { label: "Daftar Stok", path: "/koki/stok" },
];

export default function KokiSidebar() {
  ...
  return (
    <div className="w-64 bg-[#7fb3f5] h-screen flex flex-col items-center py-8 shadow-md relative z-10 flex-shrink-0">
      ...
      {/* Diubah menjadi CHEF PORTAL agar sesuai perannya */}
